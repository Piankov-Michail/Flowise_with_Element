...
class FlowiseBot:
    ...
    def generate_session_id(self, room_id: str) -> str:
        """Генерирует уникальный session_id для комнаты"""
        # Используем room_id как основу, добавляем хеш для безопасности
